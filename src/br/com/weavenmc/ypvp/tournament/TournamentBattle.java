...
public class TournamentBattle
{
    ...
    private void prepareToBattle(final Player p) {
        ...
        ItemBuilder builder = new ItemBuilder().type(Material.DIAMOND_SWORD).name("§1§lTournament Battle").enchantment(Enchantment.DAMAGE_ALL, Integer.valueOf(1)).unbreakable();
