...
public class MagmaAbility extends Ability {
	public MagmaAbility() {
		...
		this.setDescription(new String[] { "§7N\u00e3o receba dano para nenhum elemento",
				"§7relacionado \u00e1 fogo, a hitar seus", "§7oponentes h\u00e1 30% de chance de eles",
				"§7pegarem fogo, por\u00e9m receba dano na \u00e1gua." });
		this.setPrice(45000);
	...
	public void onUpdate(final UpdateEvent event) {
		...
		for (final Player o : Bukkit.getOnlinePlayers()) {
			...
			if (playerLoc.add(0.0, -1.0, 0.0).getBlock().getType().equals((Object) Material.STATIONARY_WATER)
					|| playerLoc.add(0.0, -1.0, 0.0).getBlock().getType().equals((Object) Material.WATER)) {
				o.damage(6.0);
			}
			playerLoc = null;
		}
