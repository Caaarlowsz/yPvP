...
public class PvPAbility extends Ability
{
    public PvPAbility() {
        ...
        if (yPvP.getPlugin().getPvpType() == yPvP.PvPType.FULLIRON) {
            ...
            this.setDescription(new String[] { "§7Voc\u00ea n\u00e3o recebe habilidades mas recebe", "§7uma espada de diamante com afia\u00e7\u00e3o 1." });
        }
        else {
            this.setIcon(Material.STONE_SWORD);
            this.setDescription(new String[] { "§7Voc\u00ea n\u00e3o recebe habilidades mas recebe", "§7uma espada de pedra com afia\u00e7\u00e3o 1." });
        }
    }
